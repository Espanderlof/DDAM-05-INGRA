...
import { addFollower, followUser, getProfile, getPublicationsByUser, removeFollower, unfollowUser, addComment, removeComment, getPublicationById } from "../services/firebase";
...
export const ProfileDetView = ({ navigation, route }) => {
    ...
    const handleSendComment = async () => {
        ...
        try {
            await addComment(selectedImage.id, commentText, authUid, dataUserMy.name, authEmail);
